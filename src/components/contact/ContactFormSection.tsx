            ...
            <form className="mt-12 space-y-8">
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full border-b border-white/10 bg-transparent py-2 text-white outline-none transition-colors duration-300 focus:border-cyan-300/50 appearance-none cursor-pointer">
                    <option className="bg-[#111]">Commercial</option>
                    <option className="bg-[#111]">Residential</option>
                    <option className="bg-[#111]">Mixed-Use</option>
                    <option className="bg-[#111]">Institutional</option>
                  </select>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between pt-6">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center border border-[#f0a43a]/40 bg-[#f0a43a]/5 px-10 py-4 text-[10px] font-bold uppercase tracking-[0.3em] text-[#f0a43a] transition-all duration-300 hover:bg-[#f0a43a] hover:text-black"
                >
                  {form.buttonLabel}
                </button>
              </div>
