...
const posts = [
  {
    ...
    content: `
      <h2>The Intersection of Design and Execution</h2>
      <p>In modern urban development, the separation between design intent and construction reality often creates friction. At Axiom Builders, we believe in closing this gap through design-led construction.</p>
      
      <h3>Why It Matters</h3>
      <p>When builders understand the architectural vision fundamentally, decisions on site are made to enhance, not compromise, the final form. This approach requires earlier collaboration and a shared language between architects and engineers.</p>
      
      <p>Our recent work on the silica facade projects demonstrated this perfectly. By modeling the tolerance issues in pre-construction, we avoided costly re-designs later.</p>
    `,
  ...
  },
  {
    ...
    content: `
      <h2>Front-Loading the Effort</h2>
      <p>The most expensive changes happen after the concrete is poured. This is why we invest heavily in pre-construction planning.</p>
      <p>By simulating logistics, crane positions, and material deliveries months in advance, we turn potential chaos into a choreographed sequence.</p>
    `,
  ...
  },
  {
    ...
    content: `
      <h2>More Than Texture</h2>
      <p>Materiality defines the aging process of a building. Cheap materials look good on day one but fail by year five. Premium materials require discipline to spec and install, but they pay dividends for decades.</p>
    `,
  ...
  },
  {
    ...
    content: "<p>Genesis Tower represented a unique challenge: a tight urban footprint with complex seismic requirements...</p>",
  ...
  },
  {
    ...
    content: "<p>The skin of the building is its first defense and its primary statement...</p>",
  ...
  },
  {
    ...
    content: "<p>Scale amplifies error. In large projects, a 1mm deviation at the base becomes a 1m problem at the roof if not tracked...</p>",
